...
import com.threeH.MyExhibition.tools.ExhibitionUtils;
...
public class ImageCache implements MyApplication.OnLowMemoryListener {
    ...
    public ImageCache(Context context) {
        ...
        ExhibitionUtils.getGDApplication(context).registerOnLowMemoryListener(this);
    }

    public static ImageCache from(Context context) {
        return ExhibitionUtils.getImageCache(context);
    }
